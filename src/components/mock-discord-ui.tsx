          ...
          <div className="px-2 mb-4">
            ...
            <div className="flex items-center px-2 py-1.5 rounded bg-[#393c43] text-white cursor-pointer">
              <Image
                ...
                alt="ArchCloudHub Avatar"
                width={32}
                height={32}
                className="object-cover rounded-full mr-3"
              />
              <span className="font-medium">ArchCloudHub</span>
            </div>

            <div className="my-1 space-y-px">
              {["API Gateway", "Web Frontend", "Database", "Cache"].map((service, i) => (
                <div
                  key={i}
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="h-16 bg-[#36393f] flex items-center px-4 shadow-sm border-b border-[#202225]">
          ...
          <div className="flex items-center">
            ...
            <p className="font-semibold text-white">ArchCloudHub</p>
          </div>
        ...
        <div className="p-4">
          <div className="flex items-center bg-[#40444b] rounded-lg p-1">
            ...
            <input
              readOnly
              type="text"
              placeholder="Message @ArchCloudHub"
